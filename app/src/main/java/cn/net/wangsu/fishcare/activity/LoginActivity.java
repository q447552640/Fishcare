package cn.net.wangsu.fishcare.activity;
...
import cn.net.wangsu.fishcare.MainActivity;
...
//            }
            ...
            try {
                String urlStr="http://120.77.247.25:8000/m/"+(islogin?"login":"register")+"?username="+mEmail+"&password="+mPassword;
                url = new URL(urlStr);
                ...
                if(returnCode==200){
                    ...
                    mPasswordView.setError(jsonObject.getString("returnMessage"));
                    return false;
                }
            } catch (Exception e) {
                e.printStackTrace();
                mPasswordView.setError("网络未连接");
                return false;
            } finally {
                if (connection != null) {
